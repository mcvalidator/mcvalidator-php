...
class NullableShapeOfBuilder implements Builder
{
    private $sections;
    ...
    public function set($name, $section)
    {
        ...
        return new NullableShapeOfBuilder($newOptions, $this->sections);
    }
    ...
    public function build(?Field $field = null, ?Pipeable $parent = null): Pipeable
    {
        ...
        $section = Base::getSection(Base::name('rule', 'is-nullable-shape-of'));
